...
export default function Tab() {
    ...
    const updateCartNotificationIcon = (n) => {
        switchCart.dataset.after = n;
        if (n === 0) switchCart.classList.remove(styles.notEmpty);
        else switchCart.classList.add(styles.notEmpty);
    };
    ...
    return { tab, updateCartNotificationIcon };
}
